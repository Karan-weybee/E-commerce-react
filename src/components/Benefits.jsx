          ...
          <section class="container">
            ...
            <div>
              <article>
                <ul>
                  <li>
                    <strong>Eco-sustainable:</strong> All
                    recyclable materials, 0% CO2 emissions
                  </li>
                  <li>
                    <strong>Hyphoallergenic:</strong> 100%
                    natural, human friendly ingredients
                  </li>
                  <li>
                    <strong>Handmade:</strong> All candles are
                    craftly made with love.
                  </li>
                  <li>
                    <strong>Long burning:</strong> No more
              ...
              <figure>
                <picture>
                  <source
                    ...
                    srcset={benefitImage1}
                  />
                  <img
                    src={benefitImage2}
                    alt="cosmeticos candleaf"
                  />
                </picture>
              </figure>
            </div>
